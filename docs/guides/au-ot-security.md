...
`/arckit-au:au-ot-security` generates an ASD-aligned operational technology cyber security assessment for Australian Government, regulated-sector, and critical-infrastructure projects with connected OT, ICS, SCADA, building-management, field-device, or cyber-physical environments.
...
| `/arckit-au:au-e8-posture` (`ARC-<id>-AUE8-v1.0.md`) | Enterprise cyber baseline |
| `/arckit-au:au-ism-controls` (`ARC-<id>-AUISM-v1.0.md`) | Broader ASD control evidence for IT and OT systems |
| `/arckit:risk` | Receives residual OT cyber and safety risks |

## Usage

```text
/arckit-au:au-ot-security 001
/arckit-au:au-ot-security "Water SCADA Platform"
```

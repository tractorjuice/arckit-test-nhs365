...
| `/arckit-au:au-pia` output (`ARC-<id>-AUPIA-v1.0.md`) | Automated decision-making notification posture |
...
```bash
/arckit-au:au-ai-assurance <project ID or service description>
```
...
Cross-references `/arckit-au:au-pia` (automated decision-making notification), `/arckit-au:au-ism-controls` (technical controls for model serving), and feeds `/arckit-au:au-disp-attestation` (DISP supplier AI assurance evidence for Defence-facing systems).

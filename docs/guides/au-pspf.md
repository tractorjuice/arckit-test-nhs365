...
| `/arckit-au:au-ism-controls` output (`ARC-<id>-AUISM-v1.0.md`) | Information security evidence for Outcome 4 |
| `/arckit-au:au-e8-posture` output (`ARC-<id>-AUE8-v1.0.md`) | Cyber baseline for Outcome 4 |
...
```bash
/arckit-au:au-pspf <project ID or service description>
```
...
Foundational input to `/arckit-au:au-disp-attestation` (DISP physical security, personnel security, and information protection domains draw directly from the PSPF scorecard). Cross-references back to `/arckit-au:au-ism-controls`, `/arckit-au:au-e8-posture`, and `/arckit-au:au-pia` (information protection evidence).

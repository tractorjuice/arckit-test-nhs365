...
`/arckit-fr:fr-secnumcloud` assesses cloud provider and customer obligations under ANSSI's SecNumCloud 3.2 referential — the French sovereign cloud qualification scheme. Required for OIV SIIV hosting and sensitive public sector data.
...
```bash
/arckit-fr:fr-secnumcloud Assess SecNumCloud compliance for <cloud usage and data classification>
```
...
|-------|----------------|-----------------|
| Risk | EBIOS RM study to determine risk level | `/arckit-fr:fr-ebios` |
| Security baseline | ANSSI 42 measures | `/arckit-fr:fr-anssi` |
| Cloud assessment | SecNumCloud compliance | `/arckit-fr:fr-secnumcloud` |
| Procurement | Cloud procurement clauses | `/arckit-fr:fr-marche-public` |
...
- **DINUM doctrine cloud**: The Doctrine d'utilisation de l'informatique en nuage de l'État (2022) mandates SecNumCloud or equivalent for sensitive data — run `/arckit-fr:fr-dinum` for the full doctrine assessment.

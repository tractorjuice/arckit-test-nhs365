...
`/arckit-uae:uae-ai-charter` generates a UAE Charter for the Development and Use of AI compliance assessment for a federal entity AI system. Maps the system against the 12 Charter principles and produces a bias / fairness assessment plus a human-in-the-loop design.
...
```bash
/arckit-uae:uae-ai-charter <project ID or AI system description>
```
...
| Privacy | PDPL baseline | `/arckit-uae:uae-pdpl` |
| Charter | 12-principle assessment | `/arckit-uae:uae-ai-charter` |
| Autonomy | Per-tier guard-rails | `/arckit-uae:uae-ai-autonomy-tier` |
...
- Charter posture handed off to `/arckit-uae:uae-ai-autonomy-tier` for guard-rail design.
...
- **Run order**: Run before `/arckit-uae:uae-ai-autonomy-tier` so the Charter posture informs the tier design.
- **Cross-jurisdiction projects**: For systems also touching the EU, run alongside `/arckit-eu:eu-ai-act`.

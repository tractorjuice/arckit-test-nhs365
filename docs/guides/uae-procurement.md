...
```bash
/arckit-uae:uae-procurement <project ID or procurement scope>
```
...
| Procurement | Strategy + ITT / RFP pack + ICV | `/arckit-uae:uae-procurement` |

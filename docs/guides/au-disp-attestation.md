...
| Artefact | Purpose |
|----------|---------|
| `/arckit-au:au-e8-posture` (`ARC-<id>-AUE8-v1.0.md`) | E8 ML2+ baseline for the cyber domain |
| `/arckit-au:au-ism-controls` (`ARC-<id>-AUISM-v1.0.md`) | ISM SoA underpinning Information & Cyber |
| `/arckit-au:au-pia` (`ARC-<id>-AUPIA-v1.0.md`) | Personal information handling for Information & Cyber |
| `/arckit-au:au-ndb-playbook` (`ARC-<id>-AUNDB-v1.0.md`) | Breach response capability |
| `/arckit-au:au-pspf` (`ARC-<id>-AUPSPF-v1.0.md`) | PSPF maturity for Governance, Personnel, Physical, Information |
| `/arckit-au:au-ai-assurance` (`ARC-<id>-AUAIA-v1.0.md`) | AI assurance for Defence-facing AI systems |
...
```bash
/arckit-au:au-disp-attestation <project ID or service description>
```

...
`/arckit-fr:fr-code-reuse` assesses public code reuse opportunities before building or procuring, following the legal obligation under Circulaire 2021-1524 (Prime Minister circular on free software and open source in public administration).
...
```bash
/arckit-fr:fr-code-reuse Assess code reuse for <project scope and technology domain>
```
...
| Reuse | Code reuse assessment | `/arckit-fr:fr-code-reuse` |
| Procurement | If procuring | `/arckit-fr:fr-marche-public` |

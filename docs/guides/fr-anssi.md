...
`/arckit-fr:fr-anssi` assesses compliance with the ANSSI Guide d'hygiène informatique (42 measures across 7 themes) and ANSSI cloud security recommendations. Applicable to all French organisations, public or private.
...
```bash
/arckit-fr:fr-anssi Assess ANSSI hygiene measures for <IS scope or project>
```
...
| Assessment | ANSSI 42 measures | `/arckit-fr:fr-anssi` |
| Cartography | IS mapping | `/arckit-fr:fr-anssi-carto` |
| Risk analysis | EBIOS RM study | `/arckit-fr:fr-ebios` |
| Policy | Security policy (PSSI) | `/arckit-fr:fr-pssi` |

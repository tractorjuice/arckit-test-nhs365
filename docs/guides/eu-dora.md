...
`/arckit-eu:eu-dora` generates a DORA (Digital Operational Resilience Act, Regulation EU 2022/2554) compliance assessment for financial sector entities. DORA applies from 17 January 2025 and replaces NIS2 for in-scope financial entities.
...
```bash
/arckit-eu:eu-dora Assess DORA compliance for <financial entity type>
```
...
| Assessment | DORA compliance assessment | `/arckit-eu:eu-dora` |

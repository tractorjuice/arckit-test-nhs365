...
`/arckit-fr:fr-dinum` assesses compliance with French digital administration standards: RGI (interoperability), RGAA (accessibility), RGESN (eco-design), RGS (security), and the DINUM doctrine cloud de l'État. Applicable to French public services.
...
```bash
/arckit-fr:fr-dinum Assess DINUM digital doctrine compliance for <service description>
```
...
| Code Reuse | Circulaire 2021 obligations (see `/arckit-fr:fr-code-reuse`) |
...
| Assessment | DINUM standards compliance | `/arckit-fr:fr-dinum` |
| Cloud | SecNumCloud if sensitive data | `/arckit-fr:fr-secnumcloud` |
| Code reuse | Public code obligation | `/arckit-fr:fr-code-reuse` |
...
- Code reuse: Circulaire 2021 obligations assessed (see `/arckit-fr:fr-code-reuse`).

...
The Netherlands overlay adds four commands covering Dutch central government (Rijksoverheid) information classification and cloud-hosting governance: `/arckit-nl:nl-tbb`, `/arckit-nl:nl-cloud`, `/arckit-nl:nl-bio`, and `/arckit-nl:nl-exit`. It is anchored on the Herziening rijksbreed cloudbeleid 2026 (Ministerie van Economische Zaken en Klimaat, 3 July 2026, definitief), VIRBI 2025 (Besluit voorschrift informatiebeveiliging rijksdienst bijzondere informatie 2025, BWBR0051482), and BIO2 (Baseline Informatiebeveiliging Overheid 2).

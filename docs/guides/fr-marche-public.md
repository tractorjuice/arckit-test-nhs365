...
`/arckit-fr:fr-marche-public` generates French public procurement documentation aligned with the Code de la commande publique, UGAP framework agreements, DINUM digital standards, and ANSSI-qualified provider requirements.
...
```bash
/arckit-fr:fr-marche-public Generate procurement file for <project, estimated value, procedure type>
```
...
| Assessment | Procurement strategy | `/arckit-fr:fr-marche-public` |
| Data | GDPR/data sharing clauses | `/arckit-eu:eu-rgpd`, `/arckit-eu:eu-data-act` |
| Security | SecNumCloud procurement clause | `/arckit-fr:fr-secnumcloud` |
